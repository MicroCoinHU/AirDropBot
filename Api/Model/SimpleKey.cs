...
namespace MicroCoin.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimpleKey :  IEquatable<SimpleKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleKey" /> class.
        /// </summary>
        /// <param name="CurveType">The curve type of the key. Eg: secp256k1.</param>
        /// <param name="X">Public key X coordinate in hexadecimal.</param>
        /// <param name="Y">Public key Y coordinate in hexadecimal.</param>
        public SimpleKey(string CurveType = default(string), string X = default(string), string Y = default(string))
        {
        ...
        /// </summary>
        /// <value>The curve type of the key. Eg: secp256k1</value>
        [DataMember(Name="curveType", EmitDefaultValue=false)]
        public string CurveType { get; set; }

        /// <summary>
        /// Public key X coordinate in hexadecimal
        /// </summary>
        /// <value>Public key X coordinate in hexadecimal</value>
        ...
        /// </summary>
        /// <value>Public key Y coordinate in hexadecimal</value>
        ...
        {
            return this.Equals(input as SimpleKey);
        }

        /// <summary>
        /// Returns true if SimpleKey instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleKey input)
        {
            if (input == null)
                return false;

...
namespace MicroCoin.API.Model
{
    ...
    public partial class Transaction :  IEquatable<Transaction>
    {
        ...
        public Transaction(decimal? Amount = default(decimal?), decimal? Fee = default(decimal?), string Payload = default(string), string Sender = default(string), string Target = default(string), string Hash = default(string), Signature Signature = default(Signature))
        {
            ...
            if (Target == null)
            {
                throw new InvalidDataException("Target is a required property for Transaction and cannot be null");
            }
            else
            {
                this.Target = Target;

...
namespace MicroCoin.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseAccount :  IEquatable<PurchaseAccount>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseAccount" /> class.
        /// </summary>
        ...
        public PurchaseAccount(string AccountNumber = default(string), string FounderAccount = default(string), SimpleKey NewKey = default(SimpleKey), Signature Signature = default(Signature), string Hash = default(string), decimal? Fee = default(decimal?))
        {
            // to ensure "AccountNumber" is required (not null)
            if (AccountNumber == null)
            {
                throw new InvalidDataException("AccountNumber is a required property for PurchaseAccount and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FounderAccount is a required property for PurchaseAccount and cannot be null");
            }
            else
            {
            ...
            if (Fee == null)
            {
                throw new InvalidDataException("Fee is a required property for PurchaseAccount and cannot be null");
            }
            else
            {
                this.Fee = Fee;
        ...
        {
            return this.Equals(input as PurchaseAccount);
        }

        /// <summary>
        /// Returns true if PurchaseAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of PurchaseAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseAccount input)
        {
            if (input == null)
                return false;

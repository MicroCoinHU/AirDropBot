...
namespace MicroCoin.API.Model
{
    ...
    public partial class Signature :  IEquatable<Signature>
    {
        ...
        /// </summary>
        /// <param name="R">R vector.</param>
        /// <param name="S">S Vector.</param>
        public Signature(string R = default(string), string S = default(string))
        {
            this.R = R;
            this.S = S;
        }

...
namespace MicroCoin.API.Model
{
    ...
    public partial class TransactionRequest :  IEquatable<TransactionRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="TransactionRequest" /> class.
        /// </summary>
        /// <param name="Amount">Number of coins to send (required).</param>
        /// <param name="Fee">Fee, if any Otherwise zero (required).</param>
        /// <param name="Payload">Optional payload string.</param>
        /// <param name="Sender">The sender account (required).</param>
        /// <param name="Target">The target (receiver) account (required).</param>
        /// <param name="Hash">Transaction hash to sign.</param>
        /// <param name="Signature">Signature.</param>
        public TransactionRequest(decimal? Amount = default(decimal?), decimal? Fee = default(decimal?), string Payload = default(string), string Sender = default(string), string Target = default(string), string Hash = default(string), Signature Signature = default(Signature))
        {
            // to ensure "Amount" is required (not null)
            if (Amount == null)
            {
                throw new InvalidDataException("Amount is a required property for TransactionRequest and cannot be null");
            }
            else
            {
                this.Amount = Amount;
            ...
            if (Fee == null)
            {
                throw new InvalidDataException("Fee is a required property for TransactionRequest and cannot be null");
            }
            else
            {
                this.Fee = Fee;
            ...
            if (Sender == null)
            {
                throw new InvalidDataException("Sender is a required property for TransactionRequest and cannot be null");
            }
            else
            {
                this.Sender = Sender;
            ...
            if (Target == null)
            {
                throw new InvalidDataException("Target is a required property for TransactionRequest and cannot be null");
            }
            else
            {
                this.Target = Target;
        ...
        /// </summary>
        /// <value>Number of coins to send</value>
        ...
        /// </summary>
        /// <value>Fee, if any Otherwise zero</value>
        ...
        /// </summary>
        /// <value>Optional payload string</value>
        ...
        /// The sender account
        /// </summary>
        /// <value>The sender account</value>
        ...
        /// </summary>
        /// <value>The target (receiver) account</value>
        ...
        /// </summary>
        /// <value>Transaction hash to sign</value>

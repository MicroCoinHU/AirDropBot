...
namespace MicroCoin.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChangeKey :  IEquatable<ChangeKey>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeKey" /> class.
        /// </summary>
        ...
        public ChangeKey(string AccountNumber = default(string), SimpleKey NewOwnerPublicKey = default(SimpleKey), Signature Signature = default(Signature), string Hash = default(string), decimal? Fee = default(decimal?))
        {
            // to ensure "AccountNumber" is required (not null)
            if (AccountNumber == null)
            {
                throw new InvalidDataException("AccountNumber is a required property for ChangeKey and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NewOwnerPublicKey is a required property for ChangeKey and cannot be null");
            }
            else
            {
            ...
            if (Fee == null)
            {
                throw new InvalidDataException("Fee is a required property for ChangeKey and cannot be null");
            }
            else
            {
                this.Fee = Fee;
        ...
        {
            return this.Equals(input as ChangeKey);
        }

        /// <summary>
        /// Returns true if ChangeKey instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeKey input)
        {
            if (input == null)
                return false;

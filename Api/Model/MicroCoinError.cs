...
namespace MicroCoin.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MicroCoinError :  IEquatable<MicroCoinError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroCoinError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MicroCoinError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroCoinError" /> class.
        /// </summary>
        /// <param name="ErrorCode">Error code (required).</param>
        /// <param name="Message">Error message.</param>
        /// <param name="Help">Help test or url, if any.</param>
        public MicroCoinError(int? ErrorCode = default(int?), string Message = default(string), string Help = default(string))
        {
            // to ensure "ErrorCode" is required (not null)
            if (ErrorCode == null)
            {
                throw new InvalidDataException("ErrorCode is a required property for MicroCoinError and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Help test or url, if any</value>
        ...
        {
            return this.Equals(input as MicroCoinError);
        }

        /// <summary>
        /// Returns true if MicroCoinError instances are equal
        /// </summary>
        /// <param name="input">Instance of MicroCoinError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicroCoinError input)
        {
            if (input == null)
                return false;

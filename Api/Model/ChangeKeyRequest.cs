...
namespace MicroCoin.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChangeKeyRequest :  IEquatable<ChangeKeyRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeKeyRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChangeKeyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeKeyRequest" /> class.
        /// </summary>
        /// <param name="AccountNumber">The account number of the account (required).</param>
        /// <param name="NewOwnerPublicKey">NewOwnerPublicKey (required).</param>
        /// <param name="Signature">Signature.</param>
        /// <param name="Hash">The transaction hash for signature generation. Filled by the API .</param>
        /// <param name="Fee">Transaction fee, if any, otherwise zero (required).</param>
        public ChangeKeyRequest(string AccountNumber = default(string), SimpleKey NewOwnerPublicKey = default(SimpleKey), Signature Signature = default(Signature), string Hash = default(string), decimal? Fee = default(decimal?))
        {
            // to ensure "AccountNumber" is required (not null)
            if (AccountNumber == null)
            {
                throw new InvalidDataException("AccountNumber is a required property for ChangeKeyRequest and cannot be null");
            }
            else
            {
                this.AccountNumber = AccountNumber;
            }
            // to ensure "NewOwnerPublicKey" is required (not null)
            if (NewOwnerPublicKey == null)
            {
                throw new InvalidDataException("NewOwnerPublicKey is a required property for ChangeKeyRequest and cannot be null");
            }
            else
            {
            ...
            if (Fee == null)
            {
                throw new InvalidDataException("Fee is a required property for ChangeKeyRequest and cannot be null");
            }
            else
            {
                this.Fee = Fee;
        ...
        /// <summary>
        /// Gets or Sets NewOwnerPublicKey
        /// </summary>
        [DataMember(Name="newOwnerPublicKey", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>The transaction hash for signature generation. Filled by the API </value>
        ...
        {
            return this.Equals(input as ChangeKeyRequest);
        }

        /// <summary>
        /// Returns true if ChangeKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeKeyRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.NewOwnerPublicKey == input.NewOwnerPublicKey ||
                    (this.NewOwnerPublicKey != null &&
                    this.NewOwnerPublicKey.Equals(input.NewOwnerPublicKey))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NewOwnerPublicKey != null)
                    hashCode = hashCode * 59 + this.NewOwnerPublicKey.GetHashCode();
